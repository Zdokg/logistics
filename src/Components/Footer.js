        ...
        <div className="footer-grid">
          ...
          <div className="footer-logo-section">
            <div className="logo-wrapper">
              ...
              <span className="logo-text">GSL</span>
            </div>
            <p className="footer-description">
              Golden Sunrise Logistics offers comprehensive logistics solutions tailored to meet your unique business needs.
            </p>
          ...
          <div className="footer-links-section">
            ...
            <ul className="footer-links-list">
              <li><a href="#" className="footer-link">Road Freight</a></li>
              ...
              <li><a href="#" className="footer-link">Project Cargo</a></li>
              <li><a href="#" className="footer-link">E-commerce Logistics</a></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              &copy; {new Date().getFullYear()} Golden Sunrise Logistics. All rights reserved.
            </p>
            <div className="footer-links">
              <ul className="footer-bottom-links">
                <li><a href="#" className="footer-bottom-link">Terms of Service</a></li>
                <li><a href="#" className="footer-bottom-link">Privacy Policy</a></li>
                <li><a href="#" className="footer-bottom-link">Cookie Policy</a></li>
              </ul>
            </div>
          </div>
        </div>
