// Fixed and cleaned version of the provided MessagesA.js
...
export default function MessagesA() {
  ...
  const handleSendMessage = () => {
    ...
    sendMessage(currentConversation.id, "Admin", newMessage);
    setNewMessage("");
  };
              ...
              <>
                ...
                <div className="messages-scroll" ref={chatBoxRef}>
                  {currentMessages.map((msg, i) => (
                    <p key={i} className={`message ${msg.sender === "Admin" ? "message-right" : "message-left"}`}>
